from keys import CHAVE_API  # Alterado para CHAVE_API
from unidecode import unidecode

api_key = CHAVE_API  # Atualizado para usar CHAVE_API
    ...
    if boas_vindas:
       ...
       return texto
        ...
        texto = str(
            ...
            "Caso tenha alguma sugestão, crítica ou opinião sobre o bot, fique a vontade para contatar os criadores."
